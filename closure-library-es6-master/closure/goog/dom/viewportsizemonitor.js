...
goog.dom.ViewportSizeMonitor = class extends goog.events.EventTarget {
  /**
  ...
  static getInstanceForWindow(opt_window) {
    ...
    return goog.dom.ViewportSizeMonitor.windowInstanceMap_[uid] =
        goog.dom.ViewportSizeMonitor.windowInstanceMap_[uid] || new goog.dom.ViewportSizeMonitor(currentWindow);
  }
