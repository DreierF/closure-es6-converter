...
/**
   ...
   *
   */
goog.fx.Dragger = class extends goog.events.EventTarget {
  ...
  *
  ...
  endDrag(e, opt_dragCanceled) {
    ...
    if (this.dragging_) {
      ...
      this.dispatchEvent(
          new goog.fx.DragEvent(goog.fx.Dragger.EventType.END, this, e.clientX, e.clientY, e, x, y, dragCanceled));
    } else {
      this.dispatchEvent(goog.fx.Dragger.EventType.EARLY_CANCEL);
    }
  }
    ...
    if (this.enabled_) {
      ...
      if (this.dragging_) {
        var rv = this.dispatchEvent(
            new goog.fx.DragEvent(goog.fx.Dragger.EventType.BEFOREDRAG, this, e.clientX, e.clientY, e, x, y));
  ...
  computeInitialPosition() {
    this.deltaX = this.useRightPositioningForRtl_ ? goog.style.bidi.getOffsetStart(this.target) : /** @type {!HTMLElement} */ (this.target).offsetLeft;
  ...
  static cloneNode(sourceEl) {
    ...
    switch (sourceEl.tagName) {
      ...
      case String(goog.dom.TagName.TH):
        return goog.dom.createDom(goog.dom.TagName.TABLE, null,
            goog.dom.createDom(goog.dom.TagName.TBODY, null, goog.dom.createDom(goog.dom.TagName.TR, null, clonedEl)));
...
/**
   ...
   *
   */
goog.fx.DragEvent = class extends goog.events.Event {
  ...
  * @param {boolean=} opt_dragCanceled Whether the drag has been canceled.
   */
  constructor(type, dragobj, clientX, clientY, browserEvent, opt_actX, opt_actY, opt_dragCanceled) {
    super( type);
