...
/**
   ...
   * @template VALUE
   */
goog.structs.PriorityPool = class extends goog.structs.Pool {
  /**
  * A generic pool class. If min is greater than max, an error is thrown.
  ...
  *
  ...
  constructor(opt_minCount, opt_maxCount) {
    ...
    super( opt_minCount, opt_maxCount, true);
  ...
  setDelay(delay) {
    ...
    this.delayTimeout_ = goog.global.setTimeout(goog.bind(this.handleQueueRequests_, this),
