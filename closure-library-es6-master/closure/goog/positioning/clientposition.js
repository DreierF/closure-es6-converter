...
/**
   ...
   *
   */
goog.positioning.ClientPosition = class extends goog.positioning.AbstractPosition {
  /**
  * Encapsulates a popup position where the popup is positioned relative to the
  * window (client) coordinates. This calculates the correct position to
  * use even if the element is relatively positioned to some other element. This
  ...
  *
   ...
   * @override
   */
  reposition(movableElement, movableElementCorner, opt_margin, opt_preferredSize) {
    ...
    goog.positioning.positionAtCoordinate(new goog.math.Coordinate(x, y), movableElement, movableElementCorner,
