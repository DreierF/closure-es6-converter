...
goog.i18n.BidiFormatter = class {
  ...
  constructor(contextDir, opt_alwaysSpan) {
     ...
     */
    this.estimateDirection = goog.i18n.bidi.estimateDirection;
  }
   ...
   * @private
   */
  areDirectionalitiesOpposite_(dir1, dir2) {
   ...
   * @private
   */
  dirResetIfNeeded_(str, dir, opt_isHtml, opt_dirReset) {
   ...
   */
  spanWrapSafeHtml(html, opt_dirReset) {
   ...
   * @return {!goog.html.SafeHtml} Input text after applying the processing.
   */
  spanWrapSafeHtmlWithKnownDir(dir, html, opt_dirReset) {
    if (dir == null) {
   ...
   * @private
   */
  spanWrapWithKnownDir_(dir, html, opt_dirReset) {
   ...
   * @private
   */
  unicodeWrapWithKnownDir_(dir, str, opt_isHtml, opt_dirReset) {
    opt_dirReset = opt_dirReset || (opt_dirReset == undefined);
    var result = [];
   ...
   *     the empty string.
   */
  markAfterKnownDir(dir, str, opt_isHtml) {
    if (dir == null) {
      dir = this.estimateDirection(str, opt_isHtml);
    }
