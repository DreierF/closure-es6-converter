 ...
 * @final
 */
goog.testing.MultiTestRunner = class extends goog.ui.Component {
    /**
     * A component for running multiple tests within the browser.
    ...
    constructor(opt_domHelper) {
         ...
         * @private
         */
        this.filterFn_ = goog.functions.TRUE;
         ...
         * @private
         */
        this.timeoutMs_ = goog.testing.MultiTestRunner.DEFAULT_TIMEOUT_MS;
         ...
         * @private
         */
        this.numFilesStatsBucketSize_ = 20;
         ...
         * @private
         */
        this.runTimeStatsBucketSize_ = 500;
   }
 ...
 * @final
 */
goog.testing.MultiTestRunner.TestFrame = class extends goog.ui.Component {
     ...
     * @constructor
     */
    constructor(basePath, timeoutMs, verbosePasses, opt_domHelper) {
       super(opt_domHelper);
