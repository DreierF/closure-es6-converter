 ...
 *     format definition.
  ...
  return goog.html.TrustedResourceUrl
        .createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(
          urlBase + goog.html.TrustedResourceUrl.stringifyParams_(
 ...
 * @see goog.html.TrustedResourceUrl.unwrap
 */
static unwrapTrustedScriptURL = function(
    trustedResourceUrl) {
  ...
  static format(format, args) {
    ...
    var result = formatStr.replace(goog.html.TrustedResourceUrl.FORMAT_MARKER_, function(match, id) {
      if (!Object.prototype.hasOwnProperty.call(args, id)) {
        throw new Error(
            'Found marker, "' + id + '", in format string, "' + formatStr + '", but no valid label mapping found ' + 'in args: ' + JSON.stringify(args));
      }
      var arg = args[id];
 ...
 *     format definition.
   ...
   * @package
   */
  static createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(url) {
 ...
 * @private
 */
static stringifyParams_ = function(
