...
goog.html.SafeHtml = class {
   ...
   * @private
   */
  initSecurityPrivateDoNotAccessOrElse_(html, dir) {
...
goog.html.SafeHtml.unwrapTrustedHTML = function(safeHtml) {
  ...
  static htmlEscapePreservingNewlines(textOrHtml) {
    ...
    return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(goog.string.internal.newLineToBr(goog.html.SafeHtml.unwrap(html)),
        html.getDirection());
  }
  ...
  static htmlEscapePreservingNewlinesAndSpaces(textOrHtml) {
    ...
    var html = goog.html.SafeHtml.htmlEscape(textOrHtml);
    return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(goog.string.internal.whitespaceEscape(goog.html.SafeHtml.unwrap(html)),
        html.getDirection());
  }
   ...
   */
  static createIframe(opt_src, opt_srcdoc, opt_attributes, opt_content) {
    if (opt_src) {
   ...
   */
  static createSandboxIframe(opt_src, opt_srcdoc, opt_attributes, opt_content) {
  ...
  static createMetaRefresh(url, opt_secs) {
    ...
    var attributes = {
      'http-equiv': 'refresh', 'content': (opt_secs || 0) + '; url=' + unwrappedUrl
    };
  ...
  static getStyleValue_(value) {
    if (!goog.isObject(value)) {
      throw new Error(
          'The "style" attribute requires goog.html.SafeStyle or map ' + 'of style properties, ' + (typeof value) + ' given: ' + value);
    }
   ...
   * @return {!goog.html.SafeHtml} The SafeHtml content with the tag.
   */
  static createWithDir(dir, tagName, opt_attributes, opt_content) {
...
initSecurityPrivateDoNotAccessOrElse_(
   ...
   * @package
   */
  static createSafeHtmlTagSecurityPrivateDoNotAccessOrElse(tagName, opt_attributes, opt_content) {
    var dir = null;
    var result = '<' + tagName;
   ...
   * @package
   */
  static combineAttributes(fixedAttributes, defaultAttributes, opt_attributes) {
    ...
    for (name in opt_attributes) {
      ...
      if (nameLower in fixedAttributes) {
        throw new Error(
            'Cannot override "' + nameLower + '" attribute, got "' + name + '" with value "' + opt_attributes[name] + '"');
      }
