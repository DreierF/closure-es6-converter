  ...
  addHandler(handler) {
    if (goog.debug.LOGGING_ENABLED) {
      if (goog.debug.Logger.ENABLE_HIERARCHY) {
        ...
        goog.asserts.assert(
            !this.name_, 'Cannot call addHandler on a non-root logger when ' + 'goog.debug.Logger.ENABLE_HIERARCHY is false.');
  ...
  setLevel(level) {
    if (goog.debug.LOGGING_ENABLED) {
      if (goog.debug.Logger.ENABLE_HIERARCHY) {
        ...
        goog.asserts.assert(
            !this.name_, 'Cannot call setLevel() on a non-root logger when ' + 'goog.debug.Logger.ENABLE_HIERARCHY is false.');
