...
goog.ui.ControlRenderer = class {
  ...
  decorate(control, element) {
    ...
    if (contentElem && contentElem.firstChild) {
      control.setContentInternal(
          contentElem.firstChild.nextSibling ? goog.array.clone(contentElem.childNodes) : contentElem.firstChild);
    } else {
  ...
  updateAriaState(element, state, enable) {
    ...
    if (!goog.ui.ControlRenderer.ariaAttributeMap_) {
      goog.ui.ControlRenderer.ariaAttributeMap_ = goog.object.create(goog.ui.Component.State.DISABLED, goog.a11y.aria.State.DISABLED,
          goog.ui.Component.State.SELECTED, goog.a11y.aria.State.SELECTED, goog.ui.Component.State.CHECKED, goog.a11y.aria.State.CHECKED,
      ...
      if (content) {
        if (goog.isString(content)) {
          ...
          if (goog.isArray(content)) {
            ...
            goog.array.forEach(goog.array.clone(/** @type {!NodeList<?>} */ (content)), childHandler);
          } else {
            // Node or string.
   ...
   * @private
   */
  getAppliedCombinedClassNames_(classes, opt_includedClass) {
    var toAdd = [];
  ...
  createClassByStateMap_() {
     ...
     * @private
     */
    this.classByState_ = goog.object.create(goog.ui.Component.State.DISABLED, goog.getCssName(baseClass, 'disabled'),
