...
goog.ui.Palette = class extends goog.ui.Control {
  /**
  ...
  constructor(items, opt_renderer, opt_domHelper) {
    super( items, opt_renderer || goog.ui.PaletteRenderer.getInstance(), opt_domHelper);
    this.setAutoStates(goog.ui.Component.State.CHECKED | goog.ui.Component.State.SELECTED | goog.ui.Component.State.OPENED,
        false);
  ...
  /** 
	* @override
    * @return {!goog.ui.PaletteRenderer} 
    */
  getRenderer() {
	return /** @type {!goog.ui.PaletteRenderer} */ (super.getRenderer());
  }
  ...
  handleMouseDown(e) {
    ...
    if (this.isActive()) {
      ...
      // down.
      var item = this.getRenderer().getContainingItem(this, /** @type {Node} */ (e.target));
      if (item != this.getHighlightedItem()) {
        this.setHighlightedItem(item);
      }
    }
  ...
  shouldSelectHighlightedItem_(e) {
    if (!this.getSelectedItem()) {
      ...
      return !!this.getRenderer().getContainingItem(this, /** @type {Node} */ (e.target));
    }
  }
  ...
  setSize(size, opt_rows) {
    ...
    this.size_ = goog.isNumber(size) ? new goog.math.Size(size, /** @type {number} */ (opt_rows)) : size;
...
/**
   ...
   * @private
   */
goog.ui.Palette.CurrentCell_ = class extends goog.ui.Control {
