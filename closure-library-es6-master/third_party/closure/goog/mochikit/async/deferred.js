...
goog.async.Deferred.LONG_STACK_TRACES =
  ...
  makeStackTraceLong_(error) {
    ...
    if (this.constructorStack_ && goog.isObject(error) && error.stack && // Stack looks like it was system generated. See
  ...
  then(opt_onFulfilled, opt_onRejected, opt_context) {
    var resolve, reject;
    var promise = new Goog_Promise(function(res, rej) {
   ...
   * `otherDeferred`.
   *
   * @param {!goog.async.Deferred|!Thenable} otherDeferred The Deferred
   *     to wait for.
   * @return {!goog.async.Deferred} This Deferred.
   */
...
/**
   ...
   *
   */
goog.async.Deferred.AlreadyCalledError = class extends DebugError {
  /**
  * An error sub class that is used when a Deferred has already been called.
  ...
  *
  ...
  constructor(deferred) {
    ...
    /** @override */
    this.message = 'Deferred has already fired';
    /** @override */
...
/**
   ...
   *
   */
goog.async.Deferred.CanceledError = class extends DebugError {
  /**
  * An error sub class that is used when a Deferred is canceled.
  *
...
/**
   ...
   * @struct
   */
goog.async.Deferred.Error_ = class {
  /**
  * Wrapper around errors that are scheduled to be thrown by failing deferreds
  * after a timeout.
  *
