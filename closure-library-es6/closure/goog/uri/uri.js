...
goog.Uri = class {
   ...
   * @return {!goog.Uri} The new URI object.
   */
  static create(opt_scheme, opt_userInfo, opt_domain, opt_port, opt_path, opt_query, opt_fragment, opt_ignoreCase) {
   ...
   * @private
   */
  static encodeSpecialChars_(unescapedPart, extra, opt_removeDoubleEncoding) {
