 ...
 * @suppress {underscore}
 */
goog.ui.ac.AutoComplete = class extends goog.events.EventTarget {
    /**
     ...
     * @param {goog.events.EventTarget|goog.ui.ac.Renderer} renderer An object that implements
     *        <code>
    ...
    constructor(matcher, renderer, selectionHandler) {
        ...
        goog.events.listen(renderer,
            [goog.ui.ac.AutoComplete.EventType.HILITE, goog.ui.ac.AutoComplete.EventType.SELECT, goog.ui.ac.AutoComplete.EventType.CANCEL_DISMISS,
                goog.ui.ac.AutoComplete.EventType.DISMISS], this.handleEvent, false, this);
    ...
    setToken(token, opt_fullString) {
        ...
        this.token_ = token;
        this.matcher_.requestMatchingRows(this.token_, this.maxMatches_, goog.bind(this.matchListener_, this),
            opt_fullString);
        this.cancelDelayedDismiss();
    }
    ...
    selectHilited() {
        ...
        if (index != -1) {
            ...
            if (!suppressUpdate) {
                this.dispatchEvent({
                    type: goog.ui.ac.AutoComplete.EventType.UPDATE, row: selectedRow, index: index
                });
                if (this.triggerSuggestionsOnUpdate_) {
            ...
            this.dismiss();
            this.dispatchEvent({
                type: goog.ui.ac.AutoComplete.EventType.UPDATE, row: null, index: null
            });
            return false;
        }
    }
     ...
     * @private
     */
    matchListener_(matchedToken, rows, opt_options) {
