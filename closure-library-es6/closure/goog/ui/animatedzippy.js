...
goog.ui.AnimatedZippy = class extends goog.ui.Zippy {
   ...
   */
  constructor(header, content, opt_expanded, opt_domHelper, opt_role) {
     ...
     * @type {!Function}
     */
    this.animationAcceleration = goog.fx.easing.easeOut;
  }
  ...
  setExpanded(expanded) {
    ...
    var events = [goog.fx.Transition.EventType.BEGIN, goog.fx.Animation.EventType.ANIMATE,
