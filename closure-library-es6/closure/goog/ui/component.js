...
/**
   ...
   * @suppress {underscore}
   */
goog.ui.Component = class extends goog.events.EventTarget {
  /**
  * Default implementation of UI component.
  *
  ...
  * @suppress {underscore}
  ...
  addChildAt(child, index, opt_render) {
    ...
    } else if (this.inDocument_ && !child.inDocument_ && child.element_ && child.element_.parentNode && // Under some circumstances, IE8 implicitly creates a Document Fragment
  ...
  getChild(id) {
    ...
    return (this.childIndex_ && id) ? /** @type {goog.ui.Component} */ (goog.object.get(this.childIndex_, id)) || null : null;
  }
