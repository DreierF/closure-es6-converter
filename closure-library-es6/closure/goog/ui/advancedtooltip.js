  ...
  *
  ...
  isCoordinateInTooltip(coord) {
    ...
    if (this.hotSpotPadding_) {
      ...
      return offset.x - this.hotSpotPadding_.left <= coord.x && coord.x <= offset.x + size.width + this.hotSpotPadding_.right && offset.y - this.hotSpotPadding_.top <= coord.y && coord.y <= offset.y + size.height + this.hotSpotPadding_.bottom;
    }
   ...
   */
  getHideDelayMs() {
    return this.tracking_ ? this.cursorTrackingHideDelayMs_ : super.getHideDelayMs();
  }
};
