...
/**
   ...
   *
   */
goog.ui.PopupBase = class extends goog.events.EventTarget {
  /**
  * The PopupBase class provides functionality for showing and hiding a generic
  * container element. It also provides the option for hiding the popup element
  * if the user clicks outside the popup or the popup loses focus.
  ...
  * @param {goog.ui.PopupBase.Type=} opt_type Type of popup.
  ...
  constructor(opt_element, opt_type) {
     ...
     * @private
     */
    this.type_ = goog.ui.PopupBase.Type.TOGGLE_DISPLAY;
  ...
  show_() {
    ...
    if (this.showTransition_) {
      goog.events.listenOnce(/** @type {!goog.events.EventTarget} */ (this.showTransition_), goog.fx.Transition.EventType.END, this.onShow, false, this);
  ...
  hide_(opt_target) {
    ...
    if (this.hideTransition_) {
      goog.events.listenOnce(/** @type {!goog.events.EventTarget} */ (this.hideTransition_), goog.fx.Transition.EventType.END,
