...
/**
   ...
   * 
   */
goog.ui.TableSorter = class extends goog.ui.Component {
  /**
  * A table sorter allows for sorting of a table by column.  This component can
  * be used to decorate an already existing TABLE element with sorting
  * features.
  ...
  *
  ...
  sort(column, opt_reverse) {
    ...
    if (this.header_) {
      goog.dom.classlist.remove(this.header_, this.reversed_ ? goog.getCssName('goog-tablesorter-sorted-reverse') : goog.getCssName('goog-tablesorter-sorted'));
    }
    ...
    goog.dom.classlist.add(this.header_, this.reversed_ ? goog.getCssName('goog-tablesorter-sorted-reverse') : goog.getCssName('goog-tablesorter-sorted'));
