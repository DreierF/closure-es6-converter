...
goog.date.DateRange = class {
  ...
  * @param {goog.date.Date} endDate The last date in the range.
  ...
  static thisMonth(opt_today) {
    var today = goog.date.DateRange.cloneOrCreate_(opt_today);
    return new goog.date.DateRange(goog.date.DateRange.offsetInMonths_(today, 0),
  ...
  static lastMonth(opt_today) {
    var today = goog.date.DateRange.cloneOrCreate_(opt_today);
    return new goog.date.DateRange(goog.date.DateRange.offsetInMonths_(today, -1),
...
/**
   ...
   * @final
   */
goog.date.DateRange.Iterator = class extends goog.iter.Iterator {
  /**
  * Creates an iterator over the dates in a {@link goog.date.DateRange}.
  *
