...
goog.date.Interval = class {
   ...
   */
  times(n) {
    return new goog.date.Interval(this.years * n, this.months * n, this.days * n, this.hours * n,
...
/**
   ...
   *
   *
   , the created object will contain the date
   ().
   *
   *
   * 
...
goog.date.Date = class {
  ...
  * @see goog.date.DateTime
  ...
  constructor(opt_year, opt_month, opt_date) {
     ...
     * @private
     */
    this.firstDayOfWeek_ = goog.i18n.DateTimeSymbols.FIRSTDAYOFWEEK;
    /**
     * The cut off weekday used for week number calculations. 0 = Mon, 6 = Sun.
     * @type {number}
     * @private
     */
    this.firstWeekCutOffDay_ = goog.i18n.DateTimeSymbols.FIRSTWEEKCUTOFFDAY;
  }
   ...
   */
  buildDate_(fullYear, month, date) {
  ...
  toIsoString(opt_verbose, opt_tz) {
    var str = [this.getFullYear(), goog.string.padNumber(this.getMonth() + 1, 2),
  ...
  toUTCIsoString(opt_verbose, opt_tz) {
    var str = [this.getUTCFullYear(), goog.string.padNumber(this.getUTCMonth() + 1, 2),
...
/**
   ...
   *
   *, the created object will contain the date determined().
   */
goog.date.DateTime = class extends goog.date.Date {
  /**
  * Class representing a date and time. Defaults to current date and time if none
  * is specified.
  *
  ...
  *
   */
  constructor(opt_year, opt_month, opt_date, opt_hours, opt_minutes, opt_seconds, opt_milliseconds) {
    super();
    if (goog.isNumber(opt_year)) {
      /** @override */
