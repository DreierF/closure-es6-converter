 ...
 */
goog.soy.data.UnsanitizedText = class extends goog.soy.data.SanitizedContent {
  ...
  *     unknown and thus to be estimated when necessary. Default: null.
   */
  constructor(content, opt_contentDir) {

    // EDITED: NO LONGER TRUE:
    // Calling the superclass constructor which just throws an exception.
    super();
    ...
    /** @override */
    this.contentKind = goog.soy.data.SanitizedContentKind.TEXT;
  }
};
...
goog.soy.data.SanitizedJs = class extends goog.soy.data.SanitizedContent {
  ...
  * attacker-controlled scripts. The content direction is LTR.
  ...
  constructor() {
    super();
    /** @override */
    this.contentKind = goog.soy.data.SanitizedContentKind.JS;
    /** @override */
...
goog.soy.data.SanitizedUri = class extends goog.soy.data.SanitizedContent {
  ...
  * template. The content direction is LTR.
  ...
  constructor() {
    super();
    /** @override */
    this.contentKind = goog.soy.data.SanitizedContentKind.URI;
    /** @override */
    this.contentDir = goog.i18n.bidi.Dir.LTR;
  }
...
goog.soy.data.SanitizedHtmlAttribute = class extends goog.soy.data.SanitizedContent  {
  ...
  *
  ...
  constructor() {
    super();
    /** @override */
    this.contentKind = goog.soy.data.SanitizedContentKind.ATTRIBUTES;
    /** @override */
    this.contentDir = goog.i18n.bidi.Dir.LTR;
  }
...
/**
   ...
   *
   */
goog.soy.data.SanitizedStyle = class extends goog.soy.data.SanitizedContent {
  ...
  *
  ...
  constructor() {
    super();
    /** @override */
    this.contentKind = goog.soy.data.SanitizedContentKind.STYLE;
    /** @override */
    this.contentDir = goog.i18n.bidi.Dir.LTR;
  }
  ...
  *
  ...
  toSafeStyleSheet() {
    ...
    return goog.html.uncheckedconversions.safeStyleSheetFromStringKnownToSatisfyTypeContract(
        goog.string.Const.from('Soy SanitizedCss produces SafeStyleSheet-contract-compliant ' + 'value.'), value);
  }
