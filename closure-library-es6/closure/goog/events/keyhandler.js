...
/**
   ...
   * @final
   */
goog.events.KeyHandler = class extends goog.events.EventTarget {
  /**
  * A wrapper around an element that you want to listen to keyboard events on.
  ...
  *
  ...
  handleEvent(e) {
    ...
    if (goog.userAgent.IE && e.type == goog.events.EventType.KEYPRESS) {
      ...
      if (goog.events.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ && e.type == goog.events.EventType.KEYPRESS) {
        altKey = this.altKey_;
      }
    ...
    if (goog.userAgent.GECKO && goog.events.KeyHandler.USES_KEYDOWN_ && e.type == goog.events.EventType.KEYPRESS && !goog.events.KeyCodes.firesKeyPressEvent(
...
/**
   ...
   * @final
   */
goog.events.KeyEvent = class extends goog.events.BrowserEvent {
