...
/**
   ...
   * 
   */
goog.events.InputHandler = class extends goog.events.EventTarget {
  /**
  * This event handler will dispatch events when the user types into a text
  * input, password input or a textarea
  ...
  *
  ...
  constructor(element) {
    ...
    var emulateInputEvents = goog.userAgent.IE || goog.userAgent.EDGE || (goog.userAgent.WEBKIT && !goog.userAgent.isVersionOrHigher('531') && element.tagName == goog.dom.TagName.TEXTAREA);
    ...
    // fit.)
    this.eventHandler_.listen(this.element_, emulateInputEvents ? ['keydown', 'paste', 'cut', 'drop', 'input'] : 'input',
        this);
  }
