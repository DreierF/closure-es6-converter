...
/**
   ...
   * 
   */
goog.events.WheelHandler = class extends goog.events.EventTarget {
  /**
  * This event handler allows you to catch wheel events in a consistent manner.
  ...
  *
  ...
  constructor(element, opt_capture) {
    ...
    var rtlElement = goog.dom.isElement(this.element_) ? /** @type {!Element} */ (this.element_) : /** @type {!Document} */ (this.element_).body;
