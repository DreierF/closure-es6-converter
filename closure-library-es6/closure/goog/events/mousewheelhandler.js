...
/**
   ...
   * 
   */
goog.events.MouseWheelHandler = class extends goog.events.EventTarget {
  /**
  * This event handler allows you to catch mouse wheel events in a consistent
  * manner.
  ...
  *
  ...
  constructor(element, opt_capture) {
    ...
    var rtlElement = goog.dom.isElement(this.element_) ? /** @type {Element} */ (this.element_) : (this.element_ ? /** @type {Document} */ (this.element_).body : null);
...
/**
   ...
   * @final
   */
goog.events.MouseWheelEvent = class extends goog.events.BrowserEvent {
  /**
  * A base class for mouse wheel events. This is used with the
  * MouseWheelHandler.
  *
