...
/**
   ...
   */
goog.dom.iter.SiblingIterator = class extends goog.iter.Iterator {
  /**
  * Iterator over a Node's siblings.
  ...
  *
   */
  constructor(node, opt_includeNode, opt_reverse) {
	  super();
 ...
 */
goog.dom.iter.ChildIterator = class extends goog.dom.iter.SiblingIterator {
	 ...
	 */
	constructor(element, opt_reverse, opt_startIndex) {
	  if (!goog.isDef(opt_startIndex)) {
		opt_startIndex = opt_reverse && element.childNodes.length ?
			element.childNodes.length - 1 :
			0;
	  }
	  super( element.childNodes[opt_startIndex], true, opt_reverse);
	}
}
 ...
 */
goog.dom.iter.AncestorIterator = class extends goog.iter.Iterator {
	...
	*     first return value from next.
	*/
	constructor(node, opt_includeNode) {
		super();
