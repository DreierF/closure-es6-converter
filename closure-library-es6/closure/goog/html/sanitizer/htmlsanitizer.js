 ...
 * @struct
 */
goog.html.sanitizer.HtmlSanitizer = class extends goog.html.sanitizer.SafeDomTreeProcessor {
  /**
  * Creates an HTML sanitizer.
  * @param {!goog.html.sanitizer.HtmlSanitizer.Builder=} opt_builder
   ...
   */
  sanitizeToDomNode(unsanitizedHtml) {
    this.currentStyleContainerId_ = this.getStyleContainerId_();
  ...
  /** @override */
  preProcessHtml(unsanitizedHtml) {
    ...
    goog.asserts.assert(inertUnsanitizedDom,
  ...
  createTextNode(dirtyNode) {
    ...
    if (dirtyParent && goog.html.sanitizer.noclobber.getNodeName(dirtyParent).toLowerCase() == 'style' && !('STYLE' in this.tagBlacklist_) && 'STYLE' in this.tagWhitelist_) {
      ...
      textContent = goog.html.SafeStyleSheet.unwrap(
          goog.html.sanitizer.CssSanitizer.sanitizeStyleSheetString(textContent, this.currentStyleContainerId_,
  ...
  processElementAttribute(dirtyElement, attribute) {
    ...
    var policyHints = {
      tagName: goog.string.trim(elementName).toLowerCase(), attributeName: goog.string.trim(attributeName).toLowerCase()
    };
  ...
  static wrapUrlPolicy_(urlPolicy) {
    return /** @type {!goog.html.sanitizer.HtmlSanitizerPolicy} */ (function(url, policyHints) {
   ...
   * @private
   */
  static wrapPolicy_(customPolicy, defaultPolicy) {
    return /** @type {!goog.html.sanitizer.HtmlSanitizerPolicy} */ (function(value, hints, ctx, policy) {
   ...
   * @private
   */
  static installDefaultPolicy_(whitelist, overrideList, key, defaultPolicy) {
   ...
   * @private
   */
  static attrIdentifier_(nodeName, attributeName) {
    if (!nodeName) {
      nodeName = '*';
    }
   ...
   * @private
   */
  static sanitizeCssDeclarationList_(policySanitizeUrl, attrValue, policyHints, policyContext) {
   ...
   * @private
   */
  static allowedAttributeValues_(allowedValues, attrValue, policyHints) {
   ...
   * @private
   */
  static sanitizeUrlFragment_(urlFragment, policyHints) {
   ...
   * @private
   */
  static sanitizeName_(namePolicy, attrName, policyHints) {
   ...
   * @private
   */
  static sanitizeClasses_(tokenPolicy, attrValue, policyHints) {
   ...
   * @private
   */
  static sanitizeId_(tokenPolicy, attrValue, policyHints) {
    var trimmed = goog.string.trim(attrValue);
   ...
   * @private
   */
  static getContext_(attributeName, dirtyElement) {
 ...
 * @struct
 */
goog.html.sanitizer.HtmlSanitizer.Builder = class {
  /**
  * The builder for the HTML Sanitizer. All methods except build return `this`.
   */
  constructor() {
...
return this;
   ...
   * @package
   */
  alsoAllowTagsPrivateDoNotAccessOrElse(tags) {
...
return this;
   ...
   * @return {!goog.html.sanitizer.HtmlSanitizer.Builder}
   */
  withCustomNetworkRequestUrlPolicy(customNetworkReqUrlPolicy) {
