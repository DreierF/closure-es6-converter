...
/**
   ...
   * @template KEY, VALUE
   */
goog.structs.TreeNode = class extends goog.structs.Node {
  /**
  * Generic tree node data structure with arbitrary number of child nodes.
  * It is possible to create a dynamic tree structure by overriding
  * {@link #getParent} and {@link #getChildren} in a subclass. All other getters
  ...
  *
   ...
   */
  removeChild(child) {
    return child && this.removeChildAt(goog.array.indexOf(this.getChildren(), child));
  }
   ...
   * @template KEY, VALUE
   */
  static findCommonAncestor(var_args) {
