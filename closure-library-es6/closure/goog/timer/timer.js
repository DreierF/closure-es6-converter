...
/**
   ...
   * 
   */
goog.Timer = class extends goog.events.EventTarget {
  /**
  * Class for handling timing events.
  *
  ...
  *
  ...
  constructor(opt_interval, opt_timerObject) {
     ...
     */
    this.timerObject_ = /** @type {{setTimeout, clearTimeout}} */ (opt_timerObject || goog.Timer.defaultTimerObject);
  ...
  static promise(delay, opt_result) {
    ...
    return new goog.Promise(function(resolve, reject) {
      timerKey = goog.Timer.callOnce(function() { resolve(opt_result); }, delay);
