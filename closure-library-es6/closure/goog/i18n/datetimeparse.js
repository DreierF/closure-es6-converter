...
goog.i18n.DateTimeParse = class {
  ...
  *
   ...
   * @private
   */
  internalParse_(text, date, start, validation) {
   ...
   * @private
   */
  subParse_(text, pos, part, digitCount, cal) {
   ...
   * @private
   */
  subParseYear_(text, pos, start, value, part, cal) {
    var ch;
    if (value < 0) {
      // possible sign
   ...
   * @private
   */
  subParseMonth_(text, pos, cal, value) {
   ...
   * @private
   */
  subParseQuarter_(text, pos, cal, value) {
   ...
   * @private
   */
  subParseDayOfWeek_(text, pos, cal) {
   ...
   * @private
   */
  subParseFractionalSeconds_(value, pos, start, cal) {
   ...
   * @private
   */
  subparseTimeZoneInGMT_(text, pos, cal) {
   ...
   * @private
   */
  parseTimeZoneOffset_(text, pos, cal) {
...
/**
   ...
   * @private
   */
goog.i18n.DateTimeParse.MyDate_ = class {
  /**
  * This class hold the intermediate parsing result. After all fields are
  * consumed, final result will be resolved from this class.
  *
