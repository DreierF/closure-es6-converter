...
/**
   ...
   * 
   */
goog.net.XhrManager = class extends goog.events.EventTarget {
  /**
  * A manager of an XhrIoPool.
  ...
  *
   */
  constructor(opt_maxRetries, opt_headers, opt_minCount, opt_maxCount, opt_timeoutInterval, opt_withCredentials) {
    super();
   ...
   */
  send(id, url, opt_method, opt_content, opt_headers, opt_priority, opt_callback, opt_maxRetries, opt_responseType, opt_withCredentials) {
    ...
    var request = new goog.net.XhrManager.Request(url, goog.bind(this.handleEvent_, this, id), opt_method, opt_content,
        opt_headers, opt_callback, goog.isDef(opt_maxRetries) ? opt_maxRetries : this.maxRetries_, opt_responseType,
        goog.isDef(opt_withCredentials) ? opt_withCredentials : this.withCredentials_);
   ...
   * @private
   */
  removeXhrListener_(xhrIo, func, opt_types) {
   ...
   * @private
   */
  addXhrListener_(xhrIo, func, opt_types) {
    var types = opt_types || goog.net.XhrManager.XHR_EVENT_TYPES_;
...
/**
   ...
   * @final
   */
goog.net.XhrManager.Event = class extends goog.events.Event {
  /**
  * An event dispatched by XhrManager.
  *
  ...
  *
   */
  constructor(type, target, id, xhrIo) {
    super( type, target);
...
/**
   ...
   *
   *
   : Only 1 callback supported across all events.
   *
   (Default: 1).
   *
   ; defaults to goog.net.XhrIo.ResponseType.DEFAULT.
   *
   : false.
   *
   * 
   * @final
   */
goog.net.XhrManager.Request = class {
  /**
  * An encapsulation of everything needed to make a Xhr request.
  * NOTE: This is used internal to the XhrManager.
  *
