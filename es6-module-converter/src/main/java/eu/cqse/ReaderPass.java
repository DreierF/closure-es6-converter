...
public class ReaderPass extends Es6Processor {
	...
	final ListMultimap<File, GoogRequireOrForwardDeclare> requiresByFile = ArrayListMultimap.create();
	final ListMultimap<File, GoogProvideOrModule> providesByFile = ArrayListMultimap.create();
